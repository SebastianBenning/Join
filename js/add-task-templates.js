function openAddTaskHtml(i, taskStatus) {
  ...
  <form class="addTaskForm" onkeypress="return event.keyCode != 13;" onsubmit="addToTask(${i}, '${taskStatus}'); return false; ">
    <img class="CloseCross" onclick="closeAddTaskMask(${i})" src="assets/img/group 11.png" alt="">
    <div class="addTask-top">
      <h2>Add Task</h2>
      <button type="submit" class="btn">Create Task <img src="assets/img/white-check.png" alt=""></button>
    </div>
    ...
    <div class="" id="selector_user_dropdown">  </div>
    ...
    <div class="input-subtasks" id="newSubtask_select">
      <div class="inputUser pointer">
        <div class="inputfield-new-user">
          <input class="input border-bottom colorblack" id="new_subtask_text" onkeydown="enterFunctionSubtasks(event)" type="text" placeholder="Add new subtask">
