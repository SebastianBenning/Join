setURL('https://sebastian-benning.developerakademie.net/smallest_backend_ever');
...
function checkUserIsLoggedIn() {
    ...
    if (loginStatus == 'true' && (window.location.pathname == '/Join/index.html' || window.location.pathname == '/')) {
        window.location.href = '/Join/summary.html';
    } else if (loginStatus == 'true' && window.location.pathname == '/Join/sign-up.html') {
        window.location.href = '/Join/summary.html';
    } else if (loginStatus == null && (window.location.pathname == '/Join/sign-up.html' || window.location.pathname == '/')) {

    }
    else if (loginStatus == null && window.location.pathname != '/Join/index.html') {
...
function showMenu() {
    ...
    document.getElementById('header_big_bar').classList.remove('display-none')
...
function hideAddTaskMasklogout(){
    document.getElementById('header_big_bar').classList.add('display-none');
}

function doNotCloselogout(event) {
